...
public class MysqlConnectivity{
    public static void main(String[] args){
        ...
        try{
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/librarydb","root","jay4757:)");
            ...
            switch(a)
            {
                ...
                try{
                    ...
                    String sql = " insert into student" + "(s_id, name, dob, d_id, department)" + "  values (?, ?, ?, ?, ?)";
